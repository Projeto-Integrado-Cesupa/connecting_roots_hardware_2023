  ...
  return (
    <div className="container">
      <div className="flex flex-col ">
        ...
        <div className="flex shadow-md border b-px rounded-md ">
          <div className="flex flex-col bg-smallTextColor rounded-s-md h-96 w-80 items-center">
            <Link
              to=""
              class="text-xl relative z-[2] flex w-full hover:bg-primaryColor rounded-tl-md px-2.5 py-2.5 items-center font-medium leading-tight text-white  transition duration-150 ease-in-out "
            >
              <svg
            ...
            <Link
              to="Password"
              class="text-xl relative z-[2] flex w-full hover:bg-primaryColor px-2.5 py-2.5 items-center font-medium leading-tight text-white  transition duration-150 ease-in-out "
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
