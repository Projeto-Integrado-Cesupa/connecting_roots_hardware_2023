  ...
  return (
    <div className="mt-4">
      <div className="flex flex-col mt-4 p-4 rounded-xl border border-gray-300 shadow-md col-1">
        <span className="text-lg text-smallTextColor">Membros</span>
        <div className="flex items-center justify-between mt-2">
          <div className="flex items-center">
            <div className="bg-img-member rounded-full w-[32px] h-[32px] bg-cover border border-smallTextColor"></div>
            <div className="flex items-center">
              <span className="text-lg ml-2">Rafael Maranhão</span>
            </div>
          </div>
          <svg
        ...
        <div className="flex items-center justify-between mt-2">
          <div className="flex items-center">
            <div className="bg-img-member rounded-full w-[32px] h-[32px] bg-cover border border-smallTextColor"></div>
            <div className="flex items-center">
              <span className="text-lg ml-2">Pedro Coimbra</span>
            </div>
          </div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex items-center justify-between mt-2">
          <div className="flex items-center">
            <div className="bg-img-enzo rounded-full w-[32px] h-[32px] bg-cover border border-smallTextColor"></div>
            <div className="flex items-center">
              <span className="text-lg ml-2">Enzo Martins</span>
            </div>
          </div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
